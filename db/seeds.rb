...
class1 = Session.new({'session_name' => 'spin', 'session_time' => '08:00', 'capacity' => '20'})
class1.save
class2 = Session.new({'session_name' => 'boxing', 'session_time' => '12:00', 'capacity' => '20'})
class2.save
class3 = Session.new({'session_name' => 'yoga', 'session_time' => '14:00', 'capacity' => '1'})
class3.save
